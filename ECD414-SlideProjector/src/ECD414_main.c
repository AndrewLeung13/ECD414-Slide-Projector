...
// LIBS="watchdog.o systick.o usbcdc.o uclib.o encoder.o buttons.o spi0.o spi1.o i2c0.o i2c1.o" make clean test_final.uf2
void poll_encoder();
_Bool poll_b12();
...
int32_t encoder_count = 50;  //encoder
...
uint32_t loop_time = 1000/12; //83
uint16_t trans[16];

_Bool btn_tf = 0;
_Bool btn_pressed_direction = 0;
...
void main_fsm(){
  ...
  if(clock_count >= (loop_time + encoder_count) ){
    ...
    //if encoder button held, set all expanders low, current projector to 0
